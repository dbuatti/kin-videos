-- 1. Clean up duplicates in lessons table (keep the newest one)
...
-- 2. Add unique constraint to lessons table
ALTER TABLE public.lessons 
ADD CONSTRAINT lessons_user_id_lesson_url_key UNIQUE (user_id, lesson_url);

-- 3. Clean up duplicates in video_progress table (keep the newest one)
...
-- 4. Add unique constraint to video_progress table
